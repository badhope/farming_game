...
class GameConfig:
    ...
    # 天气概率权重 [晴天，雨天，阴天，暴风雨，下雪，大风，大雾，干旱，热浪]
    WEATHER_WEIGHTS = {
        Season.SPRING: [0.35, 0.25, 0.20, 0.05, 0.0, 0.10, 0.05, 0.0, 0.0],
        Season.SUMMER: [0.45, 0.10, 0.15, 0.05, 0.0, 0.05, 0.0, 0.10, 0.10],
        Season.AUTUMN: [0.35, 0.20, 0.20, 0.05, 0.0, 0.15, 0.05, 0.0, 0.0],
